...
const Footer = () => {
  ...
  return (
    <div className="px-10 py-12 space-y-10 bg-black lg:px-20 lg:space-x-20 lg:space-y-0 lg:flex">
      <div className="flex flex-col items-center space-y-10 lg:justify-start lg:space-y-20">
        <div>
      ...
      <div className="space-y-20">
        <div className="flex items-center justify-center space-x-5 text-center lg:justify-start">
          <Link href="/">
        ...
        <p className="text-center text-lightGrey lg:text-left">
