...
const Footer = () => {
  ...
  return (
    <div className="px-10 py-12 space-y-10 bg-black md:px-20 md:space-x-20 md:space-y-0 md:flex md:justify-between lg:justify-start">
      <div className="flex flex-col items-center space-y-10 md:items-start md:justify-start md:space-y-20">
              ...
              {links.map((link, idx) => {
                return (
                  <li key={idx} className="text-center md:text-left">
                    <Link href={link.link}>
                      <a className="tracking-widest text-white uppercase">
                        {link.title}
                      </a>
                    </Link>
                  </li>
      ...
      <div className="md:hidden lg:block">
        <ul className="space-y-5">
          {links.map((link, idx) => {
            return (
              <li key={idx} className="text-center lg:text-left">
                <Link href={link.link}>
                  <a className="tracking-widest text-white uppercase hover:text-lightGrey">
                    {link.title}
                  </a>
                </Link>
              </li>
      ...
      <div className="w-full space-y-20 md:space-y-28 lg:space-y-20">
        ...
        <p className="text-center text-lightGrey md:text-right md:text-sm lg:text-base">
